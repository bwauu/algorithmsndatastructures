...
public class AlgoMultiplySmallSize {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < numberOfElements.length; i ++) {
			...
			System.out.println("Multiply all with " + numberOfElements[i] + " elements in ArrayList. Sum: " + sum + " Correct: " + (sum == correctSums[i]));
		}
		...
		for(int i = 0; i < numberOfElements.length; i ++) {
			...
			sum = test.multiplyAll(dataStructure);
			System.out.println("Multiply all with " + numberOfElements[i] + " elements in LinkedList. Sum: " + sum + " Correct: " + (sum == correctSums[i]));
		}
		...
		for(int i = 0; i < numberOfElements.length; i ++) {
			...
			System.out.println("Multiply some with " + numberOfElements[i] + " elements in ArrayList. Sum: " + sum + " Correct: " + (sum == correctSums[i]));
		}
